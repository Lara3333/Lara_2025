...
class GameLevelCave {
  constructor(path) {
    ...
    const image_data_cave = {
        name: 'cave',
        greeting: "Welcome to the cave! kys",
        src: image_src_cave,
        pixels: {height: 580, width: 1038}
    };


    // Player data for girl
    const sprite_src_girl = path + "/images/gamify/girl.png"; // be sure to include the path
    const GIRL_SCALE_FACTOR = 5;
    const sprite_data_girl = {
        id: 'girl',
        greeting: "Hi I am girl, the cave wanderer. I am looking for wisdome and adventure!",
        src: sprite_src_girl,
        SCALE_FACTOR: GIRL_SCALE_FACTOR,
        STEP_FACTOR: 1000,
        ANIMATION_RATE: 50,
        INIT_POSITION: { x: 0, y: height - (height/GIRL_SCALE_FACTOR) }, 
    ...
    // NPC data for Tux 
    const sprite_src_spider = path + "/images/gamify/spider.png"; // be sure to include the path
    const sprite_data_spider = {
      ...
      // NPC data for Bat
      const sprite_src_bat = path + "/images/gamify/bat.png"; // be sure to include the path
      const sprite_data_bat = {
        id: 'bat',
        greeting: "I love eating humans heheheheh",
        src: sprite_src_bat,
    ...
    const sprite_src_fish = path + "/images/rpg/fishies.png"; // be sure to include the path
    const sprite_data_fish = {
        id: 'Fish',
        greeting: "Hey, are you lost?",
        src: sprite_src_fish,
        SCALE_FACTOR: 10,  // Adjust this based on your scaling needs
        ANIMATION_RATE: 100,
...
const sprite_data_htmlhank = {
    ...
    this.objects = [
      ...
      { class: Player, data: sprite_data_girl },
      { class: Npc, data: sprite_data_spider },
      { class: Npc, data: sprite_data_bat },
      { class: Npc, data: sprite_data_fish },
