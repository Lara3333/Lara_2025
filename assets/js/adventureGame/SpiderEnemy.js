...
export class Spider extends Character {
    ...
    update() {
        ...
        //Random Event 2: Time Stop All Spiders
        if (GameControl.randomEventId === 2 && GameControl.randomEventState === 1) {
            this.speed = 0;
            if (this.name === "spiderSpecial") {
                GameControl.endRandomEvent();
            };
        };

        //Random Event 3: Kill a Random Spider
        ...
        switch(GameEnv.difficulty) {
         ...
         //Chance for Spider to turn Gold
    ...
    collisionAction() {
        ...
        if (this.collisionData.touchPoints.other.id === "player") {
            // Collision: Top of Spider with Bottom of Player
            if (this.collisionData.touchPoints.other.bottom && this.immune == 0) {
                GameEnv.invincible = true;
                GameEnv.spiderBounce = true;
                this.explode()
                GameEnv.playSound("spiderDeath");
        ...
        if (this.collisionData.touchPoints.other.id === "spider") {
